      ...
      <div className='mx-auto max-w-7xl'>
        ...
        <div className='gallery-scroll relative mt-12 flex snap-x snap-mandatory gap-4 overflow-x-auto overflow-y-hidden pb-4 sm:mt-14 sm:gap-5'>
          {galleryItems.map((item, i) => (
            <article key={item.title} className='group relative h-[220px] w-[260px] shrink-0 snap-start overflow-hidden rounded-[24px] bg-[#071b18] sm:h-[250px] sm:w-[290px] md:h-[320px] md:w-[390px] lg:h-[340px] lg:w-[420px]'>
